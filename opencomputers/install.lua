...
local dlTbl = {
  ...
  {link = "https://raw.github.com/shaneyu/react-oc-remote-edit/master/opencomputers/remoteedit.lua", file = "/usr/lib/remoteedit.lua"},
  {link = "http://regex.info/code/JSON.lua", file = "/usr/lib/JSON.lua"}
}
